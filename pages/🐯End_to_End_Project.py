...
housing = pd.read_csv("pages/housing.csv")
...
def EndToEndProject_Linear_Regression_UseModel():
    ...
    lin_reg = joblib.load("pages/model_lin_reg.pkl")
...
def EndToEndProject_Linear_Regression():
    ...
    # Save model lin_reg 
    joblib.dump(lin_reg, "pages/model_lin_reg.pkl")
...
def EndToEndProject_Random_Forest_Regression_Random_Search_CV_UseModel():
    ...
    final_model = joblib.load("pages/forest_reg_rand_search.pkl")
...
def EndToEndProject_Random_Forest_Regression_Random_Search_CV():
    ...
    joblib.dump(final_model, "pages/forest_reg_rand_search.pkl")
