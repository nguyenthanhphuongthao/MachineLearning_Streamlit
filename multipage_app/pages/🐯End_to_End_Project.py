...
housing = pd.read_csv("multipage_app/pages/housing.csv")
...
def EndToEndProject_Decision_Tree_Regression():
    ...
    st.write('Sai số mình phương trung bình - train:')
    ...
    st.write('Sai số mình phương trung bình - cross-validation:')
    ...
    st.write('Sai số mình phương trung bình - test:')
    st.write('%.2f' % rmse_test)

def EndToEndProject_Linear_Regression_UseModel():
    # Load model lin_reg to use
    lin_reg = LinearRegression()
    lin_reg = joblib.load("multipage_app/pages/model_lin_reg.pkl")
...
def EndToEndProject_Linear_Regression():
    # Training
    lin_reg = LinearRegression()
    lin_reg.fit(housing_prepared, housing_labels)

    # Save model lin_reg 
    joblib.dump(lin_reg, "multipage_app/pages/model_lin_reg.pkl")
...
def EndToEndProject_Random_Forest_Regression_Random_Search_CV_UseModel():
    param_distribs = {
    ...
    final_model = joblib.load("multipage_app/pages/forest_reg_rand_search.pkl")
    ...
    print('Sai số mình phương trung bình - cross-validation:')
    rmse_cross_validation = np.sqrt(-scores)
    display_scores(rmse_cross_validation)
...
def EndToEndProject_Random_Forest_Regression_Random_Search_CV():
    param_distribs = {
            'n_estimators': randint(low=1, high=200),
            'max_features': randint(low=1, high=8),
        }
    ...
    joblib.dump(final_model, "multipage_app/pages/forest_reg_rand_search.pkl")
...
def EndToEndProject_Random_Forest_Regression_Grid_Search_CV():
...
def EndToEndProject_Random_Forest_Regression():
    # Training
...
tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(["🎄Bài 01", "🎍Bài 02", "🎋Bài 03", "🌴Bài 04","🌳Bài 05","🌲Bài 06","🦉Bài 07"])

with tab1:
    st.header("🎄Decision Tree Regression")
    EndToEndProject_Decision_Tree_Regression()

with tab2:
    st.header("🎍Linear Regression UseModel")
    EndToEndProject_Linear_Regression_UseModel()
with tab3:
   st.header("🎋Linear_Regression")
   EndToEndProject_Linear_Regression()

with tab4:
    st.header("🌴Random Forest Regression Random Search CV")
    EndToEndProject_Random_Forest_Regression_Random_Search_CV()
with tab5:
    st.header("🌳Random Forest Regression Random Search CV UseModel")
    EndToEndProject_Random_Forest_Regression_Random_Search_CV_UseModel()
with tab6:
    st.header("🌲Random Forest Regression Grid Search CV")
    EndToEndProject_Random_Forest_Regression_Grid_Search_CV()
with tab7:
    st.header("🦉Random Forest Regression")
    EndToEndProject_Random_Forest_Regression()